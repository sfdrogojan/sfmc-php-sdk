...
class CreateEmailDefinitionOptionsRequest implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['track_links'] = isset($data['track_links']) ? $data['track_links'] : null;
    }
    ...
    {
        return $this->container['track_links'];
    }

    /**
     * Sets track_links
     *
     * @param bool $track_links Wraps links for tracking and reporting. Default is true.
     *
     * @return $this
     */
    public function setTrackLinks($track_links)
    {
        $this->container['track_links'] = $track_links;
