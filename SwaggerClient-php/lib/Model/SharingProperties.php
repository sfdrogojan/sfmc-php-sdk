...
class SharingProperties implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['sharing_type'] = isset($data['sharing_type']) ? $data['sharing_type'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sharing_type']) && !in_array($this->container['sharing_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'sharing_type', must be one of '%s'",
    ...
    {
        return $this->container['sharing_type'];
    }

    /**
     * Sets sharing_type
     *
     * @param string $sharing_type Indicates the permission that you are granting to the list of MIDs in sharedWith. Possible values are view, edit, or local.
     *
     * @return $this
     */
    public function setSharingType($sharing_type)
    {
        $allowedValues = $this->getSharingTypeAllowableValues();
        if (!is_null($sharing_type) && !in_array($sharing_type, $allowedValues, true)) {
        ...
        $this->container['sharing_type'] = $sharing_type;
     ...
     * Sets shared_with
     *
     * @param int[] $shared_with List of MID IDs the asset is shared with
     *
     * @return $this
     */
