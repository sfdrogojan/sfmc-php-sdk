...
class GetSmsDefinitionsResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'request_id' => 'string',
        'definitions' => '\SalesForce\MarketingCloud\PHPSDK\Model\CreateSmsDefinitionRequest[]',
        'count' => 'int',
        'page' => 'int',
        'page_size' => 'int'
    ];
     ...
     * Sets definitions
     *
     * @param \SalesForce\MarketingCloud\PHPSDK\Model\CreateSmsDefinitionRequest[] $definitions definitions
     *
     * @return $this
     */
