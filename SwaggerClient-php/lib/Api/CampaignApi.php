...
class CampaignApi extends AbstractApi
{
     ...
     * createCampaign
     *
     * @param  \SalesForce\MarketingCloud\PHPSDK\Model\Campaign $body JSON Parameters (optional)
     *
     * @throws \SalesForce\MarketingCloud\PHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SalesForce\MarketingCloud\PHPSDK\Model\Campaign
     */
     ...
     * @throws \SalesForce\MarketingCloud\PHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SalesForce\MarketingCloud\PHPSDK\Model\Campaign, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCampaignWithHttpInfo($body = null)
    {
        $returnType = '\SalesForce\MarketingCloud\PHPSDK\Model\Campaign';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SalesForce\MarketingCloud\PHPSDK\Model\Campaign',
    ...
    protected function deleteCampaignByIdRequest($id)
    {
        ...
        $resourcePath = '/hub/v1/campaigns/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
