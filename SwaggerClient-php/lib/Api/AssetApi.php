...
class AssetApi extends AbstractApi
{
     ...
     * createAsset
     *
     * @param  \SalesForce\MarketingCloud\PHPSDK\Model\Asset $body JSON Parameters (optional)
     *
     * @throws \SalesForce\MarketingCloud\PHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SalesForce\MarketingCloud\PHPSDK\Model\Asset
     */
     ...
     * @throws \SalesForce\MarketingCloud\PHPSDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SalesForce\MarketingCloud\PHPSDK\Model\Asset, HTTP status code, HTTP response headers (array of strings)
     */
    public function createAssetWithHttpInfo($body = null)
    {
        $returnType = '\SalesForce\MarketingCloud\PHPSDK\Model\Asset';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SalesForce\MarketingCloud\PHPSDK\Model\Asset',
